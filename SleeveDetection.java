...
//        Imgproc.morphologyEx(blurredMat, blurredMat, Imgproc.MORPH_CLOSE, kernel);
        ...
        Imgproc.putText(input, "maxPercent: " + maxPercent + " magPercent: " + magPercent + " yelPercent: " + yelPercent+" cyaPercent: " + cyaPercent , new Point(5, 360 - 5), 0, 0.6, new Scalar(255, 255, 255), 2);
        // Memory cleanup
        blurredMat.release();
        yelMat.release();
        cyaMat.release();

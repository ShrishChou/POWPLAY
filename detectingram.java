...
@Config
@Autonomous(name="1Left", group="Tutorials")

public class detectingram extends LinearOpMode {
...
//                        .turn(Math.toRadians(50))
                    .back(40)
                    .splineTo(new Vector2d(-36.5,-7),Math.toRadians(30))
            ...
            TrajectorySequence pick_1 = drive.trajectorySequenceBuilder(drop_1.end())
                    .splineTo(new Vector2d(-47,-11),Math.toRadians(-180))
...
//                        .forward(17.5)
                    ...
                    .addTemporalMarker(0.4, () -> {
                        rightslide.setTargetPosition(730); // 760
                        leftslide.setTargetPosition(730); // 760
                        rightslide.setPower(1);
                        leftslide.setPower(1);
                        rightslide.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                        leftslide.setMode(DcMotor.RunMode.RUN_TO_POSITION);
...
//                    .splineToLinearHeading(new Pose2d(-26,-8,Math.toRadians(-130)),Math.toRadians(90))
                    .splineTo(new Vector2d(-36,-7.5),Math.toRadians(40))
            ...
            TrajectorySequence pick_2 = drive.trajectorySequenceBuilder(drop_2.end())
                    .splineTo(new Vector2d(-47,-12),Math.toRadians(-180))
...
//                        .forward(16.5)
                    ...
                    .addTemporalMarker(0.3, () -> {
                        rightslide.setTargetPosition(590); // 640
                        leftslide.setTargetPosition(590); // 640
                        rightslide.setPower(1);
                        leftslide.setPower(1);
                        rightslide.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                        leftslide.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            ...
            Trajectory drop_3 = drive.trajectoryBuilder(pick_2.end(),true)
                    .splineTo(new Vector2d(-35,-9),Math.toRadians(50))
            ...
            TrajectorySequence pick_3 = drive.trajectorySequenceBuilder(drop_3.end())
                    .splineTo(new Vector2d(-47,-14),Math.toRadians(-180))
                    .splineTo(new Vector2d(-63,-14),Math.toRadians(-180))
...
//                        .forward(15.5)
                    ...
                    .addTemporalMarker(0.2, () -> {
                        rightslide.setTargetPosition(480); // 570
                        leftslide.setTargetPosition(480); // 570
                        rightslide.setPower(1);
                        leftslide.setPower(1);
                        rightslide.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                        leftslide.setMode(DcMotor.RunMode.RUN_TO_POSITION);
...
//                        .forward(15.5)
                    ...
                    .addTemporalMarker(0.2, () -> {
                        rightslide.setTargetPosition(660); // 760
                        leftslide.setTargetPosition(660); // 760
                        rightslide.setPower(1);
                        leftslide.setPower(1);
                        rightslide.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                        leftslide.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            ...
            Trajectory pick_5 = drive.trajectoryBuilder(pick_4.end(),true)
                    .lineToLinearHeading(new Pose2d(-18,-13,Math.toRadians(-90)))
//                        .splineTo(new Vector2d(-64,-15),Math.toRadians(-170))
...
//                        .forward(15.5)
                ...
                Trajectory pick_4 = drive.trajectoryBuilder(drop_4.end())
                        .splineTo(new Vector2d(-46,-14),Math.toRadians(-180))
...
//                        .forward(15.5)
                        ...
                        .addTemporalMarker(0.2, () -> {
                            rightslide.setTargetPosition(0); // 760
                            leftslide.setTargetPosition(0); // 760
                            rightslide.setPower(1);
                            leftslide.setPower(1);
                            rightslide.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                            leftslide.setMode(DcMotor.RunMode.RUN_TO_POSITION);
...
//                        .turn(Math.toRadians(50))
                        .back(40)
                        .splineTo(new Vector2d(-35,-8.5),Math.toRadians(30))
                        .addTemporalMarker(0.4, () -> { // from -20, -10 --> Shrish
                            upslide();
                        })
                        .addTemporalMarker(0.6, () -> { // from -20, -10 --> Shrish
...
//                        .forward(17.5)
                ...
                Trajectory drop_2 = drive.trajectoryBuilder(pick_1.end(),true)
//                    .splineToLinearHeading(new Pose2d(-26,-8,Math.toRadians(-130)),Math.toRadians(90))
                        .splineTo(new Vector2d(-34.5,-9),Math.toRadians(40))
                        .addTemporalMarker(1.2, () -> { // from -20, -10 --> Shrish
                            uparm();
                        })
                        .addTemporalMarker(2.4, () -> { // from -20, -10 --> Shrish
                ...
                TrajectorySequence pick_2 = drive.trajectorySequenceBuilder(drop_2.end())
                        .splineTo(new Vector2d(-47,-11),Math.toRadians(-180))
                        .splineTo(new Vector2d(-62,-11),Math.toRadians(-180))
//                        .forward(16.5)
                        .addTemporalMarker(0, () -> {
                            pickup();
                        })
                        ...
                        .build();
                Trajectory drop_3 = drive.trajectoryBuilder(pick_2.end(),true)
                        .splineTo(new Vector2d(-33.5,-9),Math.toRadians(50))

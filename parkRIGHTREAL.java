...
public class parkRIGHTREAL extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        rightslide.setTargetPosition(250);
        ...
        leftslide.setTargetPosition(250);
        ...
        if(tagOfInterest == null)
        {
            ...
            telemetry.update();
            sleep(20);
            Pose2d start = new Pose2d(39, -63, Math.toRadians(-90));
...
//                        .turn(Math.toRadians(50))
                    .back(40)
                    .splineTo(new Vector2d(36.5,-11.5),Math.toRadians(150))
...
//                drive.followTrajectory(drop_4);
            ...
            drop();
            sleep(200);
            Trajectory pick_5 = drive.trajectoryBuilder(drop_1.end(),true)
                    .lineToLinearHeading(new Pose2d(62.4,-17,Math.toRadians(-90)))
...
//                sleep(500);
                ...
                Trajectory pick_4 = drive.trajectoryBuilder(drop_1.end())
                        .lineToLinearHeading(new Pose2d(38.5,-14,Math.toRadians(-90)))
//                        .splineTo(new Vector2d(-64,-15),Math.toRadians(-170))
...
//                drive.followTrajectory(drop_4);
                ...
                sleep(200);
                Trajectory pick_5 = drive.trajectoryBuilder(drop_1.end(),true)
                        .lineToLinearHeading(new Pose2d(62,-17,Math.toRadians(-90)))
//                        .splineTo(new Vector2d(-64,-15),Math.toRadians(-170))

...
@Config
@Autonomous(name="Autoprev", group="Tutorials")

public class Autobluearyvar extends LinearOpMode {
...
//                    .forward(10)
            ...
            Trajectory move_to_first_deposit = drive.trajectoryBuilder(miss.end(),true)
//                    .forward(10)
                    .lineToLinearHeading(new Pose2d(-16, -10,Math.toRadians(150))) //-14
...
//                    .splineTo(new Vector2d(-60, -8), Math.toRadians(180))
                    ...
                    .addTemporalMarker(0.1, () -> {
                        rightslide.setTargetPosition(850); // 550
                        leftslide.setTargetPosition(850); // 550

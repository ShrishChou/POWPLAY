...
@Config
@Autonomous(name="1right", group="Tutorials")

public class OneRight extends LinearOpMode {
...
//                        .forward(17.5)
            ...
            Trajectory drop_2 = drive.trajectoryBuilder(pick_1.end())
                    .forward(10)
                    .splineTo(new Vector2d(35,-8.5),Math.toRadians(140))
                    .addTemporalMarker(0.4, () -> { // from -20, -10 --> Shrish
                        up();
                    })
                    .addTemporalMarker(4, () -> { // from -20, -10 --> Shrish
...
//    }
    ...
    public void pickup(){
        claw.setPosition(0.42);//close claw
    }
    public void drop(){
